...
matching documentation in `../../docs/services/admin-service/` before changes.

- Keep controllers, application services, persistence, integrations, and
  configuration separated under `src/`.
- Use Spring validation and security at the boundary; keep authorization and
  audit behavior aligned with the service SRS and integration contract.
