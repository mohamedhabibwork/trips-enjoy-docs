...
matching documentation in `../../docs/services/pricing-service/` before
changes.

- Keep controllers, application services, persistence, integrations, and
  configuration separated under `src/`.
- Preserve price calculation inputs, quote expiry, currency minor-unit
  handling, and versioned pricing behavior defined in the service documents.
