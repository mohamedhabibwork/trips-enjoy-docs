# Food Order Service Guide

This is a Kotlin 2.2 / Spring Boot 4 service running on Java 21. Read the
matching documentation in `../../docs/services/food-order-service/` before
changes.

- Keep controllers, application services, persistence, integrations, and
  configuration separated under `src/`.
- Preserve documented order states, payment and dispatch compensations,
  idempotency, and event handling semantics; update workflows when changed.
