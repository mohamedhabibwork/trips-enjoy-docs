...
class SecurityConfiguration(
    @Value("\${food-order.security.enabled:true}") private val securityEnabled: Boolean,
) {
    @Bean
            ...
            .authorizeHttpRequests { auth ->
                ...
                if (securityEnabled) {
                    auth.requestMatchers("/v1/orders/*").hasAnyAuthority(
                        "SCOPE_food_order.write", "SCOPE_food_order.read",
                        "SCOPE_customer.write", "SCOPE_restaurant.write",
                        "SCOPE_courier.write",
                    )
