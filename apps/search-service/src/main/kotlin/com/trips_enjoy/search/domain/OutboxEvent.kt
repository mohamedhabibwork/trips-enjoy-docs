...
/**
 * Search-service outbox row — Phase B of the platform-DRY initiative
 * (ADR-0028): the local entity persists into the canonical 11-column
 * outbox shape on top of the existing `search.outbox` table.
 *
 ...
 */
@Entity
@Table(name = "outbox", schema = "search")
class OutboxEvent(
    @Id val id: UUID,
