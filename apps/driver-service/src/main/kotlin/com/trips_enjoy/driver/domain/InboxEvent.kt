 ...
 * `driver.inbox_events` per docs/services/driver-service/ERD.md §3.
 * The unique index on `(source_topic, source_event_id)` is the dedup
 * primitive.
 */
@Entity
@Table(name = "inbox_events", schema = "driver")
class InboxEvent(
    @Id val id: UUID,
