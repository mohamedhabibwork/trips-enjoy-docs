# Driver Service Guide

This is a Kotlin 2.2 / Spring Boot 4 service running on Java 21. Read the
matching documentation in `../../docs/services/driver-service/` before changes.

- Keep controllers, application services, persistence, integrations, and
  configuration separated under `src/`.
- Preserve documented driver lifecycle, authorization, PII protections, and
  event handling semantics; update workflows when behavior changes.
