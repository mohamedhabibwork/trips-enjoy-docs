...
matching documentation in `../../docs/services/courier-service/` before
changes.

- Keep controllers, application services, persistence, integrations, and
  configuration separated under `src/`.
- Preserve documented courier lifecycle, dispatch, authorization, and event
  handling semantics; update workflows when behavior changes.
