...
matching documentation in `../../docs/services/audit-service/` before changes.

- Keep controllers, application services, persistence, integrations, and
  configuration separated under `src/`.
- Treat audit records as security-sensitive: preserve immutability, access
  control, retention, and correlation requirements from the service docs.
