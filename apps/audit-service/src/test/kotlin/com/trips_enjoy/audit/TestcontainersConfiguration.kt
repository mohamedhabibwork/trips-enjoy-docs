...
/**
 * Testcontainers wiring for audit-service integration tests.
 *
 ...
 * service — `spring.datasource.url` resolves to `jdbc:postgresql://0.0.0.0:5432/...`
 * from `application-dev.yml` and Hikari cannot derive a driver class.
 *
