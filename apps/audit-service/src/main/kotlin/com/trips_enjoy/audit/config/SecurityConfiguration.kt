...
//
// Permits /health, /ready, /started, /actuator/health/anything,
// /openapi.json/anything, /v3/api-docs/anything, /docs/anything.
// Everything else requires a JWT bearer token. Roles are surfaced as
// ROLE_<name> and scopes as SCOPE_<name> so controllers can use
