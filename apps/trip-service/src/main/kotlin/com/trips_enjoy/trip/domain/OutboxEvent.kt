...
/**
 * Trip-service outbox row — Phase B of the platform-DRY initiative
 * (ADR-0028): the local entity persists into the canonical 11-column
 * outbox shape on top of the existing `trip.outbox_event` table.
 *
 ...
 */
@Entity
@Table(name = "outbox_event", schema = "trip")
class OutboxEvent(
    @Id val id: UUID,
