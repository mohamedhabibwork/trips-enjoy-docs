...
matching documentation in `../../docs/services/trip-service/` before changes.

- Keep controllers, application services, persistence, integrations, and
  configuration separated under `src/`.
- Preserve documented trip state transitions, dispatch and payment
  compensations, authorization, idempotency, and event handling semantics.
