 ...
 * echoes them back, generating a fallback id when neither is present.
 *
 * The value is exposed on the request attribute `correlationId` so other
 * components (ApiExceptionHandler, application services, MDC) can read it.
 * Identical to the audit-service/identity-service filter; copied here to
 * keep this service standalone.
 */
@Component
