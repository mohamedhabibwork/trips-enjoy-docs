...
matching documentation in `../../docs/services/notification-service/` before
changes.

- Keep controllers, application services, persistence, integrations, and
  configuration separated under `src/`.
- Respect channel consent, template safety, delivery idempotency, and PII
  protections documented for notification delivery.
