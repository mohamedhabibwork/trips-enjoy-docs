...
/**
 * Establishes the per-request correlation id used across logging,
 * events, and audit_log rows (CONVENTIONS.md §2).
 *
 * Priority: X-Request-Id > X-Correlation-Id > generated UUIDv7.
 * The chosen value is set as both inbound read attribute
 * (`correlationId`) and outbound response header (both names so older
