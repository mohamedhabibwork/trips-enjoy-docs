...
matching documentation in `../../docs/services/customer-service/` before
changes.

- Keep controllers, application services, persistence, integrations, and
  configuration separated under `src/`.
- Treat customer data as PII: apply documented authorization, minimization,
  masking, audit, and retention requirements.
