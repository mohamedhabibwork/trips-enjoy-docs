...
// OutboxRow mirrors a row in the geolocation.outbox table (canonical
// DDL per docs/services/geolocation-service/ERD.md §3). The dev
// scaffold keeps rows in memory; the production implementation
