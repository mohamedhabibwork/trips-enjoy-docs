 ...
 * `payment.inbox_events` per docs/services/payment-service/ERD.md §3.
 * Unique index on `(source_topic, source_event_id)` is the dedup primitive.
 */
@Entity
@Table(name = "inbox_events", schema = "payment")
class InboxEvent(
    @Id val id: UUID,
