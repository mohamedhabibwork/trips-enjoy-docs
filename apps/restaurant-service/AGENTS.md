...
matching documentation in `../../docs/services/restaurant-service/` before
changes.

- Keep controllers, application services, persistence, integrations, and
  configuration separated under `src/`.
- Preserve merchant authorization, menu versioning, availability, and event
  handling semantics described in the service documentation.
