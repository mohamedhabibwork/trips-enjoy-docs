...
/**
 * Restaurant-service outbox row — Phase B of the platform-DRY initiative
 * (ADR-0028): the local entity persists into the canonical 11-column
 * outbox shape on top of the existing `restaurant.outbox_events` table.
 *
 ...
 */
@Entity
@Table(name = "outbox_events", schema = "restaurant")
class OutboxEvent(
    @Id val id: UUID,
