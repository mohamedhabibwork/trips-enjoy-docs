...
/**
 * Ledger-service outbox row — Phase B of the platform-DRY initiative
 ...
 * next_attempt_at) are written directly via JPA. The ledger-service
...
class OutboxEvent(
    ...
    var partitionKey: String = "ledger",
    ...
    fun onPrePersist() {
        ...
        if (partitionKey.isBlank()) partitionKey = "ledger"
    }
