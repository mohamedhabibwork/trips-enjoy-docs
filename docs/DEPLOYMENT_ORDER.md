...
|---|---|---|
| **Graduated** (implementation + tests green) | 14 / 21 | `configuration-service`, `identity-service`, `audit-service`, `ledger-service`, `notification-service`, `api-gateway`, `file-service`, `geolocation-service`, `reporting-service`, `payment-service`, `driver-service`, `courier-service`, `restaurant-service`, `pricing-service` |
