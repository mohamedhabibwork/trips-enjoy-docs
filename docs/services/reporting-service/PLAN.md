...
- [ ] Create schema `reporting`: tables per `ERD.md` (partitioned by time/zone/hash per data shape)
...
- [ ] Add `reporting.outbox` and `reporting.inbox` for reliable eventing
...
- [ ] Sync dependencies: all services
