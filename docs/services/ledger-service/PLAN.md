...
- [ ] Create schema `ledger`: tables per `ERD.md` (partitioned by time/zone/hash per data shape)
...
- [ ] Add `ledger.outbox` and `ledger.inbox` for reliable eventing
