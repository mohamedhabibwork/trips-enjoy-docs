...
- [ ] Create schema `file`: tables per `ERD.md` (partitioned by time/zone/hash per data shape)
...
- [ ] Add `file.outbox` and `file.inbox` for reliable eventing
