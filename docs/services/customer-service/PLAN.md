...
- [ ] Create schema `customer`: tables per `ERD.md` (partitioned by time/zone/hash per data shape)
...
- [ ] Add `customer.outbox` and `customer.inbox` for reliable eventing
