...
This PLAN.md is the source of truth for **how** `delivery-service` is built. The 10-phase
...
- [ ] Create schema `delivery`: tables per `ERD.md` (partitioned by time/zone/hash per data shape)
...
- [ ] Add `delivery.outbox` and `delivery.inbox` for reliable eventing
...
|-------|-------|---------|--------------|
| `delivery.pickup` | derived from name | see INTEGRATION.md | see INTEGRATION.md |
| `delivery.in_transit` | derived from name | see INTEGRATION.md | see INTEGRATION.md |
| `delivery.completed` | derived from name | see INTEGRATION.md | see INTEGRATION.md |
| `delivery.failed` | derived from name | see INTEGRATION.md | see INTEGRATION.md |

### Events Consumed
| Event | Producer | Handler |
|-------|----------|---------|
| `delivery.courier.assigned` | see INTEGRATION.md | see INTEGRATION.md |
| `courier.location.updated` | see INTEGRATION.md | see INTEGRATION.md |
