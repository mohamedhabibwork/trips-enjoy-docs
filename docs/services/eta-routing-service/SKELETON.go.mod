...
module github.com/trips-enjoy/platform/eta-routing-service
...
require (
    ...
    require github.com/go-resty/resty/v2 v2.x
)

    // ----------------------------------------------------------------------
    // External vendor SDK placeholder
    // ----------------------------------------------------------------------
    // map provider (Google/Mapbox/HERE)
    //
