...
// Language: Kotlin (Spring Boot 4 (coroutines))
//
...
dependencies {
    ...
    // Spring WebFlux / R2DBC (reactive services: pricing-service, tax-service, dispatch-service)
    implementation("org.springframework.boot:spring-boot-starter-webflux")
    implementation("io.asyncer:r2dbc-postgresql:1.x")
