# driver-incentive-service — Implementation Plan

**Domain:** Ride-Hailing
**Tier:** 5
**Technology:** Python/FastAPI
**Criticality:** T3 (99.5%)
**DB Schema:** `driver_incentive`
**Cache:** Redis — goal window
**HPA:** CPU 70%, 2–6, p99 < 300ms
...
This PLAN.md is the source of truth for **how** `driver-incentive-service` is built. The 10-phase
...
- [ ] Create schema `driver_incentive`: tables per `ERD.md` (partitioned by time/zone/hash per data shape)
...
- [ ] Add `driver_incentive.outbox` and `driver_incentive.inbox` for reliable eventing
...
- [ ] Sync dependencies: configuration-service, trip-service
...
|-------|-------|---------|--------------|
| `driver.incentive.earned` | derived from name | see INTEGRATION.md | see INTEGRATION.md |
