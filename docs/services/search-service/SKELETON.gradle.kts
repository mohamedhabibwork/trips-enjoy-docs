...
// Language: Kotlin (Spring Boot 4 + Spring Data OpenSearch)
//
...
dependencies {
    ...
    // Spring Data OpenSearch 6 (search-service only)
    implementation("org.springframework.data:spring-data-opensearch:6.x")
