...
dependencies {
    ...
    // Hibernate Spatial (PostGIS integration for zone-service / geolocation-service)
    implementation("org.hibernate.orm:hibernate-spatial:7.x")
